<div class="container-fluid bg-img text-secondary bg-dark" style="margin-top: 90px">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">NEP NIC Building Mehran UET Jamshoro Sindh Pakistan </p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">printifyzz@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+92 333 3444 099</p>
                            </div>
                            <div class="d-flex mt-4">
                                <a class="btn btn-lg btn-primary rounded-circle me-2" href="https://api.whatsapp.com/send?phone=3333444099" target="_blank"><i class="bi bi-whatsapp fw-bold"></i></a>
                                <a class="btn btn-lg btn-primary rounded-circle me-2" href="https://www.facebook.com/printifyz" target="_blank"><i class="bi bi-facebook fw-bold"></i></a>
                                <a class="btn btn-lg btn-primary rounded-circle me-2" href="https://twitter.com/printifyz"><i class="bi bi-twitter fw-bold" target="_blank"></i></a>
                                <a class="btn btn-lg btn-primary rounded-circle me-2" href="https://www.instagram.com/printifyz"><i class="bi bi-instagram fw-bold" target="_blank"></i></a>
                            </div>
                        </div>
    ...
    <div class="container-fluid text-secondary py-4" style="background: #111111;">
        <div class="container text-center">
            <p class="mb-0">All Rights Reserved. &copy; <?php date_default_timezone_set("Asia/karachi"); echo date("Y"); ?> <a class="text-white border-bottom" href="index.php">Printifyz (Pvt) Ltd</a>. <a class="text-white border-bottom" href="#"><b></b></a></p>
        </div>
    </div>
    <!-- Footer End -->
