...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-12">
			<img src="img/banners/17.png" class="img-fluid w-100" alt="image Here" style="max-height: 500px;">
		</div>
	</div>
		...
		<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 text-center mb-5 pt-5 border border-1 border-top-0 border-bottom-0">
			<div>
				<div class="row pt-5 border border-bottom-1 border-top-0 text-start">
					<h4 class="text-uppercase">Baby and Kids</h2>
			...
			<div class="row p-5 mt-5">
				...
				<a href="https://api.whatsapp.com/send?phone=3333444099" target="_blank">	
					...
					<div class="row text-center mt-1">
						<span style="color:#EE3226E5;" class="col-lg-6 col-md-12 col-sm-12 float-start fw-bolder">PKR 100</span>
